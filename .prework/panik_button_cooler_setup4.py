...
def install_panik_button():
    ...
    for shortcut in shortcuts:
        ...
        subprocess.run(["dconf", "write", f"{path}/binding", shortcut['key'].strip("'")])

    # Print the final message
    print("\nFinal message with instructions:")
    instructions = [
        f"Press {TOGGLE_KEY.strip("'")} to toggle panik mode.",
        f"Press {DEACTIVATE_KEY.strip("'")} to deactivate panik mode.",
        f"Press {ACTIVATE_KEY.strip("'")} to activate panik mode.",
