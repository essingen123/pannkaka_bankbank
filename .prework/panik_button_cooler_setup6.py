...
def install_panik_button():
    ...
    shortcuts = [
        ...
        {"name": "Panik Button Deactivate", "command": "gnome-terminal -- bash -c 'rm /tmp/panik_mode && script_path'", "key": "DEACTIVATE_KEY", "index": 1},
        {"name": "Panik Button Activate", "command": "gnome-terminal -- bash -c 'script_path'", "key": "ACTIVATE_KEY", "index": 2},
    ]

    for shortcut in shortcuts:
        path = f"/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom{shortcut['index']}"
