...
## KEEP THIS WORKING EXAMPLE:  💻$ dconf write /org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom0/binding "'<Primary><Shift><Alt>t'" && dconf write /org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom0/command "'/usr/bin/notify-send HÄJ; echo 'meta or super hmm didnt work for windows key, uncertain!' '"
